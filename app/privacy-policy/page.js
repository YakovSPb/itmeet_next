...
const page = () => {
    return (
        <div className="in_main">
            <h1 className="h1 in_main__h1">Политика конфиденциальности</h1>
            <div className="breadcrumbs breadcrums_block" typeof="BreadcrumbList">
                <div className="container">
                    <span property="itemListElement" typeof="ListItem">
                        <a property="item" typeof="WebPage" title="Перейти к ITMEET." href="https://itmeet.ru" className="home">
                            <span property="name">Главная</span>
                        </a>
                     </span> / <span
                    property="itemListElement" typeof="ListItem"><span property="name"
                                                                       className="post post-page current-item">Политика конфиденциальности</span></span></div>
            </div>
            <div className="container">
                ...
                <div className="content">
                    ...
                    <p>Настоящая политика обработки персональных данных составлена в соответствии с требованиями
                        ...
                        предпринимаемые&nbsp;Кондратьев Яков Александрович&nbsp;(далее – Оператор).</p>
                    ...
                    <p>1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее – Политика)
                        ...
                        веб-сайта&nbsp;https://prospekt.pro.&nbsp;</p>
                    ...
                    <p>2.8. Персональные данные – любая информация, относящаяся прямо или косвенно к определенному или
                        определяемому Пользователю веб-сайта&nbsp;https://prospekt.pro;</p>
                    <p>2.9. Пользователь – любой посетитель веб-сайта&nbsp;https://itmeet.ru;</p>
                    ...
                    <p>4.1. Цель обработки персональных данных Пользователя —&nbsp;
                        <mark>предоставления услуг и отправки коммерческих предложений</mark>
                        .
                    </p>
                    <p>4.2. Также Оператор имеет право направлять Пользователю уведомления о новых продуктах и услугах,
                        ...
                        почты&nbsp;info@prospekt.pro&nbsp;с пометкой «Отказ от уведомлений о новых продуктах и услугах и
                    ...
                    <p>5.1. Оператор обрабатывает персональные данные Пользователя только в случае их заполнения и/или
                        ...
                        сайте&nbsp;https://prospekt.pro. Заполняя соответствующие формы и/или отправляя свои
                    ...
                    <p>6.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их
                        ...
                        Оператора&nbsp;info@prospekt.pro&nbsp;с пометкой «Актуализация персональных данных».</p>
                    <p>6.4. Срок обработки персональных данных является неограниченным. Пользователь может в любой
                        ...
                        посредством электронной почты на электронный адрес Оператора&nbsp;info@prospekt.pro&nbsp;с
                    ...
                    <p>8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по
                        адресу&nbsp;https://prospekt.pro/privacy-policy/.</p>
                </div>
            </div>
        </div>
    )
