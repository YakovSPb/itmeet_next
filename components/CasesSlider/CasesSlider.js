...
export default function CasesSlider() {
    ...
    return (
        <div className={"container slider"}>
                        ...
                        <div className="cases_item">
                            <a href="#" className="cases_item__link">
                                ...
                                {item.lists.length && <ul className="cases_item__list">
                                    {item.lists.map((li, index) => <li key={index} className="cases_item__li">{li}</li>)}
                                </ul>}
                            </a>
                        </div>
                    </div>
            ...
            <div className="y_prevArrow slick-arrow" onClick={handlePrevClick}><i className="fa fa-angle-left"></i></div>
            <div className="y_nextArrow slick-arrow" onClick={handleNextClick}><i className="fa fa-angle-right"></i></div>
        </div>
    );
}